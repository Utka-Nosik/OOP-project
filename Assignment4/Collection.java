...
public class Collection {
    ...
    public String getCollectionAsString(String collectionName) {
        ...
        String sqlAlbums = "SELECT id, name, author, genre, year FROM albums WHERE collection_id = (SELECT id FROM collections WHERE name = ?)";
        String sqlSongs = "SELECT name, duration FROM songs WHERE album_id = ?";
